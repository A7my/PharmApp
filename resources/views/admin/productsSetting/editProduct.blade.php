            ...
            <div class="container-fluid">
                ...
                <form action="{{url('updateProduct' , $product->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div style="text-algin:center">
                        <img src="{{URL::asset('image/product/' . $product->image)}}" style="margin: auto" heigth="200px" width="200px" class="img-fluid">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Product Name</label>
                        <input type="text" value="{{$product->name}}" name="name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Prodcut Name">
                    </div>
                    @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$product->description}}" name="description" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Description">
                    </div>
                    @error('description')
                    <div class="alert alert-danger" role="alert">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$product->price}}" name="price" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Price">
                    </div>
                    @error('price')
                        <div class="alert alert-danger" role="alert">
                            price required
