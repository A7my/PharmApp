...
<head>
    ...
    <title>Update Delivery Man</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <form action="{{url('updateDeliveryman' , $d_men->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="exampleInputEmail1">Delivery Man Name</label>
                            <input type="text" name="name" value="{{$d_men->name}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Delivery Man Name">
                        </div>
                        @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" value="{{$d_men->email}}" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                        </div>
                        @error('email')
                        <div class="alert alert-danger" role="alert">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="phone" value="{{$d_men->phone_number}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Phone Numberr">
                        </div>
                        @error('phone')
                        <div class="alert alert-danger" role="alert">
                            Phone required
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="address" value="{{$d_men->address}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Address">
                        </div>
                        @error('address')
                            <div class="alert alert-danger" role="alert">
                                Address requierd
