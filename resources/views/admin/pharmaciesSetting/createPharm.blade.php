...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <form action="{{url('storePharmacy')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="exampleInputEmail1">Pharmacy Name</label>
                    <input type="text" name="name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Pharmacy Name">
                    <small id="emailHelp" class="form-text text-muted">This is pharmacy name</small>
                </div>
                @error('name')
                ...
                <div class="form-group">
                    ...
                    <small id="emailHelp" class="form-text text-muted">This is address</small>
                </div>
                @error('address')
                <div class="alert alert-danger" role="alert">
                    Pharmacy required
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phone_number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Pharmacy Phone Number">
                    <small id="emailHelp" class="form-text text-muted">This is pharmacy phone number</small>
                </div>
                @error('phone_number')
                <div class="alert alert-danger" role="alert">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="delivery" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Pharmacy Delivery Time">
                    <small id="emailHelp" class="form-text text-muted">This is  pharmacy delivery time</small>
                </div>
                @error('delivery')
                <div class="alert alert-danger" role="alert">
