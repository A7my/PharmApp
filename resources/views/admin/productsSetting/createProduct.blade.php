        ...
        <div class="container-fluid">
            ...
            <form action="{{url('storeProduct')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <small id="emailHelp" class="form-text text-muted">This is product name</small>
                </div>
                @error('name')
                ...
                <div class="form-group">
                    ...
                    <small id="emailHelp" class="form-text text-muted">This is Description</small>
                </div>
                @error('description')
                    <div class="alert alert-danger" role="alert">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="price" clCategoryass="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Product Price">
                    <small id="emailHelp" class="form-text text-muted">This is product price  </small>
                </div>
                @error('price')
                    <div class="alert alert-danger" role="alert">
                        Price Required
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="quantity" clCategoryass="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Quantity">
                    <small id="emailHelp" class="form-text text-muted">This is product qunatity  </small>
                </div>
                @error('quantity')
                    <div class="alert alert-danger" role="alert">
                        Quantity Requird
                ...
                <select name="category" style="background-color: white; border: 1px solid #ccc; border-radius: 4px;color: #555;font-size: 16px;padding: 5px 10px;width: 100%;max-width: 400px;box-sizing: border-box;">
                ...
                <select name="pharmacy" style="background-color: white; border: 1px solid #ccc; border-radius: 4px;color: #555;font-size: 16px;padding: 5px 10px;width: 100%;max-width: 400px;box-sizing: border-box;">
                    <option selected><-- Pharmacy --></option>
                    <?php $pharms=Pharmacy::get(); ?>
                    @foreach ( $pharms as $p)
