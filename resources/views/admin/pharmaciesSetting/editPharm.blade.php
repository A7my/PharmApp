    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <!-- Page Heading -->
                <form action="{{url('updatePharmacy' , $pharm->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div style="text-algin:center">
                        <img src="{{URL::asset('image/pharmacy/' . $pharm->image)}}" style="margin: auto" heigth="200px" width="200px" class="img-fluid">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Pharmacy Name</label>
                        <input type="text" value="{{$pharm->name}}" name="name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Category Name">
                    </div>
                    @error('name')
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Pharmacy Phone Number</label>
                        <input type="text" value="{{$pharm->phone_number}}" name="phone_number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Category Name">
                    </div>
                    @error('phone_number')
                        <div class="alert alert-danger" role="alert">
                            phone number required and be unique
                        </div>
                    @enderror

                    <div class="form-group">
                        <label for="exampleInputEmail1">Pharmacy  Address</label>
                        <input type="text" value="{{$pharm->address}}" name="address" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Category Name">
                    </div>
                    @error('address')
                        <div class="alert alert-danger" role="alert">
                            address required
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Pharmacy Delivery Time</label>
                        <input type="text" value="{{$pharm->delivery}}" name="delivery" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Category Name">
                    </div>
                    @error('delivery')
                        <div class="alert alert-danger" role="alert">
                    ...
                    <div class="mb-3">
                        <label for="formFile" class="form-label">Change Pharmacy Image</label>
                ...
                @if (Session::has('updatePharm'))
                <div class="alert alert-success" role="alert">
                    {{Session::get('updatePharm')}}
                </div>
                @endif
                <!-- /.container-fluid -->
