            ...
            <div class="container-fluid">
                ...
                <form action="{{url('updateCategory' , $category->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div style="text-algin:center">
                        <img src="{{URL::asset('image/category/' . $category->image)}}" style="margin: auto" heigth="200px" width="200px" class="img-fluid">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Category Name</label>
                        <input type="text" value="{{$category->name}}" name="name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Category Name">
                        <small id="emailHelp" class="form-text text-muted">This is category name</small>
                    </div>
                        @error('name')
                        ...
                        @enderror
                    <div class="mb-3">
                        <label for="formFile" class="form-label">Change Category Image</label>
